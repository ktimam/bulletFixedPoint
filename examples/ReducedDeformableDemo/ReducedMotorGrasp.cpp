                ...
                if (supportsJointMotor(mb, link))
                {
                    ...
                    if (motor)
                    {
                        if (dofIndex == 6)
                        {
                            ...
                            motor->setMaxAppliedImpulse((btScalar)10);
                        }
                        if (dofIndex == 7)
                        {
                            motor->setVelocityTarget(fingerTargetVelocities[1], (btScalar)1);
                        ...
                        motor->setMaxAppliedImpulse((btScalar)25);
                    }
                }
...
btMultiBody* ReducedMotorGrasp::createFeatherstoneMultiBody(btMultiBodyDynamicsWorld* pWorld, const btVector3& basePosition, const btVector3& baseHalfExtents, const btVector3& linkHalfExtents, bool floating)
{
    ...
    parentComToCurrentCom.push_back(btVector3((btScalar)0, -linkHalfExtents[1] * (btScalar)2.f, -baseHalfExtents[2] * (btScalar)2.f));
    parentComToCurrentCom.push_back(btVector3((btScalar)0, -linkHalfExtents[1] * (btScalar)2.f, baseHalfExtents[2] * (btScalar)2.f));//par body's COM to cur body's COM offset

    
    btVector3 currentPivotToCurrentCom((btScalar)0, -linkHalfExtents[1]* (btScalar)2.f, (btScalar)0);                         //cur body's COM to cur body's PIV offset
