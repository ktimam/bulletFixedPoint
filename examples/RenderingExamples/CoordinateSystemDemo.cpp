...
public:
	...
	virtual void physicsDebugDraw(int debugDrawFlags)
	{
		...
		btQuaternion rotAroundX(xUnit, (btScalar)m_x);
		btQuaternion rotAroundY(yUnit, (btScalar)m_y);
		btQuaternion rotAroundZ(zUnit, (btScalar)m_z);

		btScalar radius = (btScalar)0.5;
		...
		drawArc(xUnit, xUnit, toX.normalized(), radius, radius, (btScalar)0.4, SIMD_2_PI, xUnit, false);
		drawArc(yUnit, yUnit, toY.normalized(), radius, radius, (btScalar)0.4, SIMD_2_PI, yUnit, false);
		drawArc(zUnit, zUnit, toZ.normalized(), radius, radius, (btScalar)0.4, SIMD_2_PI, zUnit, false);
	}
