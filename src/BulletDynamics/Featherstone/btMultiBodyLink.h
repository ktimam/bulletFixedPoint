...
struct btMultibodyLink
{
	...
	btMultibodyLink()
		: m_mass(1),
		  m_parent(-1),
		  m_zeroRotParentToThis((btScalar)0, (btScalar)0, (btScalar)0, (btScalar)1),
		  m_cachedRotParentToThis((btScalar)0, (btScalar)0, (btScalar)0, (btScalar)1),
          m_cachedRotParentToThis_interpolate((btScalar)0, (btScalar)0, (btScalar)0, (btScalar)1),
		  m_collider(0),
		  m_flags(0),
		  m_dofCount(0),
		  m_posVarCount(0),
		  ...
		  m_jointMaxVelocity(0)
	{
		...
		setAxisTop(0, (btScalar)0., (btScalar)0., (btScalar)0.);
		setAxisBottom(0, (btScalar)1., (btScalar)0., (btScalar)0.);
		...
		//
		m_jointPos[0] = m_jointPos[1] = m_jointPos[2] = m_jointPos[4] = m_jointPos[5] = m_jointPos[6] = (btScalar)0.f;
		m_jointPos[3] = (btScalar)1.f;  //"quat.w"
		m_jointTorque[0] = m_jointTorque[1] = m_jointTorque[2] = m_jointTorque[3] = m_jointTorque[4] = m_jointTorque[5] = (btScalar)0.f;
