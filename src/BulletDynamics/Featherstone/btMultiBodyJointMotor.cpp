												 ...
												 const btContactSolverInfo& infoGlobal)
{
	...
	for (int row = 0; row < getNumRows(); row++)
	{
		...
		fillMultiBodyConstraint(constraintRow, data, jacobianA(row), jacobianB(row), dummy, dummy, dummy, dummy, posError, infoGlobal, -m_maxAppliedImpulse, m_maxAppliedImpulse, false, (btScalar)1, false, rhs);
