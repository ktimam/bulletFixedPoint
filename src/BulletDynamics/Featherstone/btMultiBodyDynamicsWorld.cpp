...
#define output &m_scratch_r[bod->getNumDofs()]
                        ...
                        bod->computeAccelerationsArticulatedBodyAlgorithmMultiDof((btScalar)0., m_scratch_r, m_scratch_v, m_scratch_m,
                        ...
                        bod->applyDeltaVeeMultiDof(&delta_qd[0], (btScalar)1);
                        //
                        if (!doNotUpdatePos)
                        {
		...
		for (int b = 0; b < m_multiBodies.size(); b++)
		{
			...
			if (!isSleeping)
			{
                ...
                else
                {
                    ...
                    bod->stepPositionsMultiDof((btScalar)1, 0, pRealBuf);
			...
			for (int b = 0; b < m_multiBodies.size(); b++)
			{
				...
				for (int m = 0; m < bod->getNumLinks(); m++)
				{
					...
					if (bod->getLink(m).m_jointType == btMultibodyLink::eRevolute)
					{
						...
						btVector4 color((btScalar)0, (btScalar)0, (btScalar)0, (btScalar)1);  //1,1,1);
