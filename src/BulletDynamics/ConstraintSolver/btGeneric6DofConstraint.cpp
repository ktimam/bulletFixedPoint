...
{
	if (needApplyTorques() == false) return (btScalar)0.0f;
	...
	{
		return (btScalar)0.0f;  //no need for applying force
	}
	...
	if (unclippedMotorImpulse > (btScalar)0.0f)
	{
