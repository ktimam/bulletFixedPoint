	  ...
	  m_axis2(axis2)
{
	...
	setAngularLowerLimit(btVector3((btScalar)1.f, (btScalar)0.f, -SIMD_HALF_PI * (btScalar)0.5f));
	setAngularUpperLimit(btVector3((btScalar)-1.f, (btScalar)0.f, SIMD_HALF_PI * (btScalar)0.5f));
	// enable suspension
	enableSpring(2, true);
	setStiffness(2, SIMD_PI * SIMD_PI * (btScalar)4.f);
	setDamping(2, (btScalar)0.01f);
	setEquilibriumPoint();
}
