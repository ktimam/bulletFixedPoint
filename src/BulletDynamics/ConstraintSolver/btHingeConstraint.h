...
public:
	...
	void setLimit(btScalar low, btScalar high, btScalar _softness = (btScalar)0.9f, btScalar _biasFactor = (btScalar)0.3f, btScalar _relaxationFactor = (btScalar)1.0f)
	{
#ifdef _BT_USE_CENTER_LIMIT_
	...
	{
#ifdef _BT_USE_CENTER_LIMIT_
		return m_limit.getHalfRange() > (btScalar)0;
#else
