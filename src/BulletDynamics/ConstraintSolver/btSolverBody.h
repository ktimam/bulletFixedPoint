...
btSolverBody
{
	...
	void writebackVelocityAndTransform(btScalar timeStep, btScalar splitImpulseTurnErp)
	{
		...
		if (m_originalBody)
		{
			...
			if (m_pushVelocity[0] != (btScalar)0.f || m_pushVelocity[1] != (btScalar)0 || m_pushVelocity[2] != (btScalar)0 || m_turnVelocity[0] != (btScalar)0.f || m_turnVelocity[1] != (btScalar)0 || m_turnVelocity[2] != (btScalar)0)
			{
