...
public:
	...
	void setLimit(btScalar _swingSpan1, btScalar _swingSpan2, btScalar _twistSpan, btScalar _softness = (btScalar)1.f, btScalar _biasFactor = (btScalar)0.3f, btScalar _relaxationFactor = (btScalar)1.0f)
	{
