	  ...
	  m_axis2(axis2)
{
	...
	setAngularLowerLimit(btVector3((btScalar)0.f, -SIMD_HALF_PI + UNIV_EPS, -SIMD_PI + UNIV_EPS));
	setAngularUpperLimit(btVector3((btScalar)0.f, SIMD_HALF_PI - UNIV_EPS, SIMD_PI - UNIV_EPS));
}
