	...
	btScalar distance)
{
	...
	btScalar combinedRestitution = (btScalar)0.f;
	btScalar restitution = combinedRestitution * -rel_vel;

	btScalar positionalError = solverInfo.m_erp * -distance / solverInfo.m_timeStep;
	btScalar velocityError = -((btScalar)1.0f + restitution) * rel_vel;  // * damping;
	btScalar denom0 = body1->computeImpulseDenominator(contactPositionWorld, normal);
	btScalar denom1 = body2 ? body2->computeImpulseDenominator(contactPositionWorld, normal) : (btScalar)0.f;
	...
	normalImpulse = (btScalar)0.f > normalImpulse ? (btScalar)0.f : normalImpulse;
