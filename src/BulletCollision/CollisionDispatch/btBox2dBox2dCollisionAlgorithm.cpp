							   ...
							   const btBox2dShape* poly2, const btTransform& xf2)
{
	...
	int index = 0;
	btScalar minDot = (btScalar)BT_LARGE_FLOAT;
					   ...
					   const btBox2dShape* polyB, const btTransform& xfB)
{
	...
	clipPoints1[0].v.setValue((btScalar)0, (btScalar)0, (btScalar)0);
	clipPoints1[1].v.setValue((btScalar)0, (btScalar)0, (btScalar)0);

	ClipVertex clipPoints2[2];
	clipPoints2[0].v.setValue((btScalar)0, (btScalar)0, (btScalar)0);
	clipPoints2[1].v.setValue((btScalar)0, (btScalar)0, (btScalar)0);
