...
//#define USE_HEIGHTFIELD_TRIANGLES
	...
	btVector3 red((btScalar)1, (btScalar)0, (btScalar)0), green((btScalar)0, (btScalar)1, (btScalar)0), blue((btScalar)0, (btScalar)0, (btScalar)1), white((btScalar)1, (btScalar)1, (btScalar)1), black((btScalar)0, (btScalar)0, (btScalar)0);
	btVector3 tri_normal;
	tri_shape->calcNormal(tri_normal);
	...
	// Get closest edge
	int bestedge = -1;
	btScalar disttobestedge = (btScalar)BT_LARGE_FLOAT;
	//
	// Edge 0 -> 1
