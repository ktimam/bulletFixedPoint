...
bool btPolyhedralConvexShape::initializePolyhedralFeatures(int shiftVerticesByMargin)
{
	...
	if (shiftVerticesByMargin)
	{
		...
		conv.compute(&tmpVertices[0].getX(), sizeof(btVector3), tmpVertices.size(), (btScalar)0.f, (btScalar)0.f);
	}
	else
	{
		conv.compute(&orgVertices[0].getX(), sizeof(btVector3), orgVertices.size(), (btScalar)0.f, (btScalar)0.f);
	}
...
btVector3 btPolyhedralConvexShape::localGetSupportingVertexWithoutMargin(const btVector3& vec0) const
{
	...
	{
		vec.setValue((btScalar)1, (btScalar)0, (btScalar)0);
	}
	else
	{
...
btPolyhedralConvexAabbCachingShape::btPolyhedralConvexAabbCachingShape()
	: btPolyhedralConvexShape(),
	  m_localAabbMin((btScalar)1, (btScalar)1, (btScalar)1),
	  m_localAabbMax((btScalar)-1, (btScalar)-1, (btScalar)-1),
...
void btPolyhedralConvexAabbCachingShape::recalcLocalAabb()
{
	...
	static const btVector3 _directions[] =
		{
			btVector3((btScalar)1., (btScalar)0., (btScalar)0.),
			btVector3((btScalar)0., (btScalar)1., (btScalar)0.),
			btVector3((btScalar)0., (btScalar)0., (btScalar)1.),
			btVector3((btScalar)-1., (btScalar)0., (btScalar)0.),
			btVector3((btScalar)0., (btScalar)-1., (btScalar)0.),
			btVector3((btScalar)0., (btScalar)0.,(btScalar)-1.)};
