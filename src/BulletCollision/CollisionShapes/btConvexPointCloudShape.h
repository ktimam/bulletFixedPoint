...
public:
	...
	{
		m_localScaling.setValue((btScalar)1.f, (btScalar)1.f, (btScalar)1.f);
	...
	void setPoints(btVector3 * points, int numPoints, bool computeAabb = true, const btVector3& localScaling = btVector3((btScalar)1.f, (btScalar)1.f, (btScalar)1.f))
	{
		m_unscaledPoints = points;
		m_numPoints = numPoints;
		m_localScaling = localScaling;
