	...
	: m_userValue3(0), m_triangleInfoMap(0)
{
	initialize(heightStickWidth, heightStickLength, heightfieldData,
			   /*heightScale=*/(btScalar)1, minHeight, maxHeight, upAxis, PHY_FLOAT,
			   flipQuadEdges);
}
...
{
	initialize(heightStickWidth, heightStickLength, heightfieldData,
			   /*heightScale=*/(btScalar)1, minHeight, maxHeight, upAxis, PHY_DOUBLE,
			   flipQuadEdges);
}
	...
	m_triangleInfoMap(0)
{
	...
	if (hdt == PHY_FLOAT) hdt = PHY_DOUBLE;
#endif
	btScalar minHeight = (btScalar)0.0f;
	...
	PHY_ScalarType hdt, bool flipQuadEdges)
{
	...
	switch (m_upAxis)
	{
		case 0:
		{
			m_localAabbMin.setValue(m_minHeight, (btScalar)0, (btScalar)0);
			m_localAabbMax.setValue(m_maxHeight, m_width, m_length);
			break;
		}
		case 1:
		{
			m_localAabbMin.setValue((btScalar)0, m_minHeight, (btScalar)0);
			m_localAabbMax.setValue(m_width, m_maxHeight, m_length);
			break;
		};
		case 2:
		{
			m_localAabbMin.setValue((btScalar)0, (btScalar)0, m_minHeight);
...
void btHeightfieldTerrainShape::getAabb(const btTransform& t, btVector3& aabbMin, btVector3& aabbMax) const
{
	...
	btVector3 localOrigin((btScalar)0, (btScalar)0, (btScalar)0);
...
void btHeightfieldTerrainShape::processAllTriangles(btTriangleCallback* callback, const btVector3& aabbMin, const btVector3& aabbMax) const
{
	...
	btVector3 localAabbMin = aabbMin * btVector3((btScalar)1.f / m_localScaling[0], (btScalar)1.f / m_localScaling[1], (btScalar)1.f / m_localScaling[2]);
	btVector3 localAabbMax = aabbMax * btVector3((btScalar)1.f / m_localScaling[0], (btScalar)1.f / m_localScaling[1], (btScalar)1.f / m_localScaling[2]);
...
void gridRaycast(Action_T& quadAction, const btVector3& beginPos, const btVector3& endPos, int indices[3])
{
	...
	if (rs.maxDistanceFlat < (btScalar)0.0001)
	{
		...
		rayDirectionFlatX = (btScalar)0;
		rayDirectionFlatZ = (btScalar)0;
	}
	else
	{
	...
	float num = (static_cast<int>(rayDirectionFlatX > (btScalar)0 ? (btScalar)1 : rayDirectionFlatX < (btScalar)0 ? (btScalar)-1 : (btScalar)0));
	const int xiStep = num;
	float num2 = (static_cast<int>(rayDirectionFlatZ > (btScalar)0 ? (btScalar)1 : rayDirectionFlatZ < (btScalar)0 ? (btScalar)-1 : (btScalar)0));
	const int ziStep = num2;

	const btScalar infinite = (btScalar)9999999;
	const btScalar paramDeltaX = xiStep != 0 ? (btScalar)1.f / btFabs(rayDirectionFlatX) : infinite;
	const btScalar paramDeltaZ = ziStep != 0 ? (btScalar)1.f / btFabs(rayDirectionFlatZ) : infinite;
