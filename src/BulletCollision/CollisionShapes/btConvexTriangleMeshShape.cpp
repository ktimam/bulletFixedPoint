...
void btConvexTriangleMeshShape::calculatePrincipalAxisTransform(btTransform& principal, btVector3& inertia, btScalar& volume) const
{
	...
	public:
		CenterCallback() : first(true), ref((btScalar)0, (btScalar)0, (btScalar)0), sum((btScalar)0, (btScalar)0, (btScalar)0), volume(0)
		{
		}
	...
	public:
		InertiaCallback(btVector3& center) : sum((btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0, (btScalar)0), center(center)
		{
		}
