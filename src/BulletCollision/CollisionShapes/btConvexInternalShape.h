...
public:
	...
	void setSafeMargin(btScalar minDimension, btScalar defaultMarginMultiplier = (btScalar)0.1f)
	{
	...
	void setSafeMargin(const btVector3& halfExtents, btScalar defaultMarginMultiplier = (btScalar)0.1f)
	{
