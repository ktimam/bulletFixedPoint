...
{
	m_bvhAabbMin.setValue((btScalar)-SIMD_INFINITY, (btScalar)-SIMD_INFINITY, (btScalar)-SIMD_INFINITY);
	m_bvhAabbMax.setValue((btScalar)SIMD_INFINITY, (btScalar)SIMD_INFINITY, (btScalar)SIMD_INFINITY);
}
...
void btQuantizedBvh::walkStacklessTreeAgainstRay(btNodeOverlapCallback* nodeCallback, const btVector3& raySource, const btVector3& rayTarget, const btVector3& aabbMin, const btVector3& aabbMax, int startNodeIndex, int endNodeIndex) const
{
	...
	btScalar lambda_max = (btScalar)1.0;
	...
	unsigned int sign[3] = {rayDirectionInverse[0] < (btScalar)0.0, rayDirectionInverse[1] < (btScalar)0.0, rayDirectionInverse[2] < (btScalar)0.0};
#endif
	...
	while (curIndex < m_curNodeIndex)
	{
		...
		rayBoxOverlap = aabbOverlap ? btRayAabb2(raySource, rayDirectionInverse, sign, bounds, param, (btScalar)0.0f, lambda_max) : false;
...
void btQuantizedBvh::walkStacklessQuantizedTreeAgainstRay(btNodeOverlapCallback* nodeCallback, const btVector3& raySource, const btVector3& rayTarget, const btVector3& aabbMin, const btVector3& aabbMax, int startNodeIndex, int endNodeIndex) const
{
	...
	unsigned int sign[3] = {rayDirection[0] < (btScalar)0.0, rayDirection[1] < (btScalar)0.0, rayDirection[2] < (btScalar)0.0};
#endif
...
//#define VISUALLY_ANALYZE_BVH 1
		...
		if (boxBoxOverlap)
		{
			...
			rayBoxOverlap = btRayAabb2(raySource, rayDirection, sign, bounds, param, (btScalar)0.0f, lambda_max);
...
{
	reportBoxCastOverlappingNodex(nodeCallback, raySource, rayTarget, btVector3((btScalar)0, (btScalar)0, (btScalar)0), btVector3((btScalar)0, (btScalar)0, (btScalar)0));
}
