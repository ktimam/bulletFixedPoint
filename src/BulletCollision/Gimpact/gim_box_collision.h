...
public:
	...
	{
		m_min[0] = (btScalar)G_REAL_INFINITY;
		m_min[1] = (btScalar)G_REAL_INFINITY;
		m_min[2] = (btScalar)G_REAL_INFINITY;
		m_max[0] = (btScalar)-G_REAL_INFINITY;
		m_max[1] = (btScalar)-G_REAL_INFINITY;
		m_max[2] = (btScalar)-G_REAL_INFINITY;
	}
