...
public:
	btGImpactShapeInterface()
	{
		...
		m_needs_update = true;
		localScaling.setValue((btScalar)1.f, (btScalar)1.f, (btScalar)1.f);
	}
	...
	*/
	...
	public:
		...
		TrimeshPrimitiveManager()
		{
			...
			m_part = 0;
			m_margin = (btScalar)0.01f;
			m_scale = btVector3((btScalar)1.f, (btScalar)1.f, (btScalar)1.f);
			m_lock_count = 0;
			vertexbase = 0;
			numverts = 0;
			stride = 0;
		...
		SIMD_FORCE_INLINE void get_vertex(unsigned int vertex_index, btVector3& vertex) const
		{
			if (type == PHY_DOUBLE)
			{
				btScalar* dvertices = (btScalar*)(vertexbase + vertex_index * stride);
			...
			{
				btScalar* svertices = (btScalar*)(vertexbase + vertex_index * stride);
