...
public:
	...
	btScalar Get_Total_Time(void) { return TotalTime; }
...
public:
	...
	btScalar Get_Current_Total_Time(void) { return CurrentChild->Get_Total_Time(); }
	...
	btScalar Get_Current_Parent_Total_Time(void) { return CurrentParent->Get_Total_Time(); }
...
public:
	...
	static btScalar Get_Time_Since_Reset(void);
