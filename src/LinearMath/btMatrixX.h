...
typedef btMatrixX<btScalar> btMatrixXf;
typedef btVectorX<btScalar> btVectorXf;
...
inline void setElem(btMatrixXf& mat, int row, int col, btScalar val)
{
	mat.setElem(row, col, val);
}
