...
btVector3 TriNormal(const btVector3 &v0, const btVector3 &v1, const btVector3 &v2)
{
	...
	if (m == (btScalar)0) return btVector3((btScalar)1, (btScalar)0, (btScalar)0);
...
btScalar DistanceBetweenLines(const btVector3 &ustart, const btVector3 &udir, const btVector3 &vstart, const btVector3 &vdir, btVector3 *upoint, btVector3 *vpoint)
{
	...
	btScalar dist = (btScalar)abs(distu - distv);
	if (upoint)
	{
		btPlane plane;
...
btVector3 orth(const btVector3 &v)
{
	btVector3 a = btCross(v, btVector3((btScalar)0, (btScalar)0, (btScalar)1));
	btVector3 b = btCross(v, btVector3((btScalar)0, (btScalar)1, (btScalar)0));
...
int4 HullLibrary::FindSimplex(btVector3 *verts, int verts_count, btAlignedObjectArray<int> &allow)
{
	...
	if (p0 == p1 || basis[0] == btVector3((btScalar)0, (btScalar)0, (btScalar)0))
		return int4(-1, -1, -1, -1);
	...
	if (btDot(verts[p3] - verts[p0], btCross(verts[p1] - verts[p0], verts[p2] - verts[p0])) < (btScalar)0)
	{
		btSwap(p2, p3);
	}
...
#define EPSILON btScalar(0.000001) /* close enough to consider two btScalaring point numbers to be 'the same'. */
	...
	btScalar recip[3] = { (btScalar)0.f, (btScalar)0.f, (btScalar)0.f};
