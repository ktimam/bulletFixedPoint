...
public:
	...
	DefaultColors
	{
		...
		DefaultColors()
			: m_activeObject((btScalar)1, (btScalar)1, (btScalar)1),
			  m_deactivatedObject((btScalar)0, (btScalar)1, (btScalar)0),
			  m_wantsDeactivationObject((btScalar)0, (btScalar)1, (btScalar)1),
			  m_disabledDeactivationObject((btScalar)1, (btScalar)0, (btScalar)0),
			  m_disabledSimulationObject((btScalar)1, (btScalar)1, (btScalar)0),
			  m_aabb((btScalar)1, (btScalar)0, (btScalar)0),
			  m_contactPoint((btScalar)1, (btScalar)1, (btScalar)0)
		{
		}
	};
	...
	virtual void drawTransform(const btTransform& transform, btScalar orthoLen)
	{
		...
		drawLine(start, start + transform.getBasis() * btVector3(orthoLen, (btScalar)0, (btScalar)0), btVector3(btScalar(1.), btScalar(0.3), btScalar(0.3)));
		drawLine(start, start + transform.getBasis() * btVector3((btScalar)0, orthoLen, (btScalar)0), btVector3(btScalar(0.3), btScalar(1.), btScalar(0.3)));
		drawLine(start, start + transform.getBasis() * btVector3((btScalar)0, (btScalar)0, orthoLen), btVector3(btScalar(0.3), btScalar(0.3), btScalar(1.)));
	}
	...
	{
		btVector3 start = transform.getOrigin();
		btVector3 offsetHeight((btScalar)0, (btScalar)0, (btScalar)0);
		...
		btVector3 yaxis((btScalar)0, (btScalar)0, (btScalar)0);
		yaxis[upAxis] = btScalar(1.0);
		btVector3 xaxis((btScalar)0, (btScalar)0, (btScalar)0);
		xaxis[(upAxis + 1) % 3] = btScalar(1.0);
		drawArc(start - transform.getBasis() * (offsetHeight), transform.getBasis() * yaxis, transform.getBasis() * xaxis, radius, radius, (btScalar)0, SIMD_2_PI, color, false, btScalar(10.0));
		drawArc(start + transform.getBasis() * (offsetHeight), transform.getBasis() * yaxis, transform.getBasis() * xaxis, radius, radius, (btScalar)0, SIMD_2_PI, color, false, btScalar(10.0));
	}
	...
	virtual void drawCone(btScalar radius, btScalar height, int upAxis, const btTransform& transform, const btVector3& color)
	{
		...
		offsetHeight[upAxis] = halfHeight;
		btVector3 offsetRadius((btScalar)0, (btScalar)0, (btScalar)0);
		offsetRadius[(upAxis + 1) % 3] = radius;
		btVector3 offset2Radius((btScalar)0, (btScalar)0, (btScalar)0);
